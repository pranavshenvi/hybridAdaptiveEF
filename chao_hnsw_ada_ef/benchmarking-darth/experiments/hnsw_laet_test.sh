...
dataset_params=(
  ...
  "glove100       16 500 500  2 100  10000 0.95 1362   1.0"
  "msmarco_v1     16 500 2000 2 1000 6980  0.95 1504   1.0"
  "msmarco_v2.1   16 500 2000 2 1000 1677  0.95 1704   1.0"
  "laion_i2i      16 500 2000 2 1000 10000 0.95 1920   1.0"
  "laion_t2i      16 500 2000 2 1000 10000 0.95 4208   1.0"
 "uniform_cluster 16 500 2000 2 1000 10000 0.95 1094   1.0"
 "zipfian_cluster 16 500 2000 2 1000 10000 0.95 4844   1.0"
)
...
do
    ...
    do
        ./../build/hnsw-test/hnsw_test \
            ...
            #   --output ${RESULTS_DIRECTORY}/${mode}/${ds}/k${k}/times/M${M}_efC${efC}_efS${efS}_qs${sample}_tr${target_recall}_t${time}.txt \ #disable logging
