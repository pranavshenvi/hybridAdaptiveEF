...
struct HNSW {
  ...
  HNSWStats search_declarative_recall_data_generation(
      DistanceComputer& qdis,
      ResultHandler<C>& res,
      VisitedTable& vt,
      idx_t query_idx,
      DeclarativeRecallDataCollectorHNSW decl_recall,
      std::string* observations,
      idx_t query_idx_for_table,
      const SearchParametersHNSW* params = nullptr) const;

  HNSWStats search_baseline(
      DistanceComputer& qdis,
      ResultHandler<C>& res,
      VisitedTable& vt,
      idx_t query_idx,
      DeclarativeRecallDataCollectorHNSW bsearchMonitor,
      const SearchParametersHNSW* params = nullptr) const;

  HNSWStats search_DARTH(
      DistanceComputer& qdis,
      ResultHandler<C>& res,
      VisitedTable& vt,
      idx_t query_idx,
      DARTHPredictorHNSW recallPredictor,
      const SearchParametersHNSW* params = nullptr) const;

  HNSWStats search_LAET(
      DistanceComputer& qdis,
      ResultHandler<C>& res,
      VisitedTable& vt,
      idx_t query_idx,
      LAETPredictorHNSW laetPredictor,
      const SearchParametersHNSW* params = nullptr) const;

  HNSWStats search_optimal_early_stop(
      DistanceComputer& qdis,
      ResultHandler<C>& res,
      VisitedTable& vt,
      idx_t query_idx,
      DeclarativeRecallDataCollectorHNSW searchMonitor,
      const SearchParametersHNSW* params = nullptr) const;
