...
struct IndexIVF : Index, IndexIVFInterface {
    ...
    void search_preassigned_training_data_generation(
            idx_t n,
            const float* x,
            idx_t k,
            const idx_t* keys,
    ...
    void search_preassigned_plainIVF(
            idx_t n,
            const float* x,
            idx_t k,
            const idx_t* keys,
            ...
            bool store_pairs,
            DeclarativeRecallDataCollectorIVF searchMonitor,
            const IVFSearchParameters* = nullptr,
            IndexIVFStats* ivf_stats = nullptr) const;

    void search_preassigned_DARTH(
            idx_t n,
            const float* x,
            idx_t k,
            const idx_t* keys,
    ...
    void search_generate_training_data(
            idx_t n,
            const float* x,
            idx_t k,
            float* distances,
