...
dataset_params=(  
  ...
  "glove100       16 500 500  2 100  10000 0.95 1730 346"
  "msmarco_v1     16 500 2000 2 1000 6980  0.95 4072 814"
  "msmarco_v2.1   16 500 2000 2 1000 1677  0.95 4542 908"
  "laion_i2i      16 500 2000 2 1000 10000 0.95 4634 926"
  "laion_t2i      16 500 2000 2 1000 10000 0.95 7170 1431"
 "uniform_cluster 16 500 2000 2 1000 10000 0.95 911  182"
 "zipfian_cluster 16 500 2000 2 1000 10000 0.95 3461 692"
)
...
do
    ...
    do
        ...
        # --output $RESULTS_DIRECTORY/${mode}/${ds}/k${k}/times/M${M}_efC${efC}_efS${efS}_qs${sample}_tr${target_recall}_ipi${initial_prediction_interval}_mpi${min_prediction_interval}_t${time}.txt \ #disable logging
    done
